    ...
    return AppBar(
      ...
      title: TextFormField(
        decoration: InputDecoration(
          ...
          suffix: IconButton(icon: Icon(Icons.clear,color: Colors.grey[800],),onPressed: clearSearch,)
        ),
    ...
    return Container(
      child: Center(
        child: ListView(
          shrinkWrap: true,
          children: <Widget>[
            SvgPicture.asset('assets/search.svg',height: orientation == Orientation.portrait ? 300.0 : 200.0,),
            Text(
              'Find Users',
